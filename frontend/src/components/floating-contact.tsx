...
export function FloatingContact() {
  const { contact, whatsapp, isLoading } = useContactInfo()
  ...
  return (
    <div className="fixed bottom-44 right-6 z-40 flex flex-col gap-3 sm:bottom-24">
      {buttons.map((btn, index) => (
        <motion.a
          ...
          className={`flex h-12 w-12 items-center justify-center rounded-full text-white shadow-lg ${btn.bg}`}
